        ...
        <footer id="footer">
            <div className="footer-content">
                <div className='footer-left'>
                    <img className='footer-logo' src={logo} alt="AQSYV logo" />
                    <div className='footer-text'>
                        <p className='copyright'>&copy; 2021 AQSYV</p>
                ...
                <div className='footer-right'>
                    <div className='contact-methods'>
                        <a className='email-link' href="mailto:hello@crosspath.com">hello@aqsyv.com</a>
